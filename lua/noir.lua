...
cmd 'highlight Type        cterm=none ctermfg=255'
...
cmd 'highlight VertSplit          ctermfg=0 ctermbg=0'
...
cmd 'highlight lualine_a_terminal cterm=bold, ctermfg=0, ctermbg=87'
cmd 'highlight lualine_b_terminal ctermfg=87, ctermbg=0'
